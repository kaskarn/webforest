...
Modify specifications after creation using the pipe operator.
...
| Argument | Description |
|----------|-------------|
| `color` | Column name for marker fill colors |
| `shape` | Column name for marker shapes |
| `opacity` | Column name for marker opacity |
| `size` | Column name for marker size multipliers |
...
```r
spec |> set_row_style(bold = NULL, italic = NULL, color = NULL, bg = NULL, ...)
```
