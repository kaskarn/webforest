...
| `foreground` | `"#333333"` | Primary text color | Labels, data values, headers |
| `primary` | `"#0891b2"` | Primary accent color | Row group backgrounds, hover states, selection |
| `secondary` | `"#64748b"` | Secondary text/UI color | Subtitles, less prominent text |
| `accent` | `"#8b5cf6"` | Accent color for emphasis | Reserved for custom use |
| `muted` | `"#94a3b8"` | Muted/disabled text color | Footnotes, captions |
