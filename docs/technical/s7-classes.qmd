...
webforest uses [S7](https://rconsortium.github.io/S7/), R's modern object-oriented system, for its internal data structures. S7 provides:
...
# Plot method (renders as forest plot)
