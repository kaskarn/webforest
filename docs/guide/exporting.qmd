...
1. **From R** - Use `save_plot()` for programmatic export
2. **From the browser** - Click the download button on interactive plots

Both methods use the same rendering engine, ensuring consistent output.
