...
1. **Check column names** - Are they spelled correctly and exist in the data?
2. **Check data types** - Are numeric columns actually numeric?
3. **Check for NAs** - Are there unexpected missing values?
4. **Check scale** - Using `scale = "log"` with non-positive values?
5. **Check dependencies** - Is V8 installed for exports?
