...
| Feature | Purpose | Visual |
|---------|---------|--------|
| **`group`** | Create collapsible sections from a column | Header rows with chevrons, click to collapse |
| **`row_type`** | Manual section headers and summaries | "header", "summary", "spacer" row types |

Use `group` for automatic grouping from your data. Use `row_type` for manually structured layouts with subtotals.
:::
